    ...
    return (
        <div style={{ backgroundColor: '#fff', minHeight: '100vh' }}>
            <div className="container dus-ka-dum">
                <Header backgroundColor={'#fff'} title={"Withdraw"} path={location?.state?.from || "/"} />

                <div className="withdrawal__page__balance__section mt-4">
                    <center>
                        <div className="withdrawal__page__balance__section__top" style={{ color: '#434343' }}>My Balance</div>
                        <div
