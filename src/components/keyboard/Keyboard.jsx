...
const Keyboard = ({ amount, setAmount, color }) => {
    ...
    return (
        <div className='keyboard-container'>
            <div className='number' style={{backgroundColor: color}}>
                <span onClick={() => handleNumberClick(1)}>
                    1
                </span>
            </div>

            <div className='number mx-auto' style={{backgroundColor: color}}>
                <span onClick={() => handleNumberClick(2)}>
                    2
                </span>
            </div>

            <div className='number ms-auto' style={{backgroundColor: color}}>
